...
#    thrust_sea_level  = vehicle.propulsors['Turbo Fan'].thrust_design
    
    

    #modified by anil 13-10-2014
    #number_of_engines = vehicle.propulsors.gt_engine.number_of_engines
    #thrust_sea_level  = vehicle.propulsors.gt_engine.thrust_design    
