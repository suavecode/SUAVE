...
def vehicle_setup():
    ...
    wing.twists.root             = 6.5 * Units.degrees
    ...
    wing.spans.projected         = 71*Units.ft

    wing.chords.root             = 23*Units.ft
    wing.chords.tip              = 8*Units.ft  
    wing.chords.mean_aerodynamic = 15.5*Units.ft

    wing.areas.reference         = 1097*(Units.ft**2.)

    wing.twists.root             = 3.0 * Units.degrees
    wing.twists.tip              = 3.0 * Units.degrees  

    wing.origin                  = [53.5,0,0]
    wing.aerodynamic_center      = [wing.chords.mean_aerodynamic/4.,0,0]
    ...
    wing.spans.projected         = 10.5

    wing.chords.root             = 7.
    wing.chords.tip              = 2.3
    wing.chords.mean_aerodynamic = 4.

    wing.areas.reference         = 1311.*(Units.feet**2.)
    ...
    fuselage.lengths.total         = 206.5*Units.ft
    fuselage.lengths.fore_space    = 6.
    fuselage.lengths.aft_space     = 5.    

    fuselage.width                 = 6.4

    fuselage.heights.maximum       = 6.4
    fuselage.heights.at_quarter_length          = 6.4
    fuselage.heights.at_three_quarters_length   = 6.4
    fuselage.heights.at_wing_root_quarter_chord = 6.4

    fuselage.areas.side_projected  = 142.1948 #these not correct
    fuselage.areas.wetted          = 446.718
    fuselage.areas.front_projected = 12.57

    fuselage.effective_diameter    = 6.4 #4.0
