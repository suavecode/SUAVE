...
def main():
    ...
    filename = 'b737.txt'    #aero data filename
...
#-----------propulsion------------------------------------------------------------------------    
    ...
    Ductedfan.engine_sizing_ductedfan(st)   #calling the engine sizing method 
    ...
    Boeing737_800.add_component(Ductedfan)
# add a simple aerodynamic model
    wing_aero = SUAVE.Attributes.Aerodynamics.CFD_Aero()
    wing_aero.initialize(Boeing737_800,Cl_var)
