...
def main():
    ...
    while (flag > 20.0):
        ...
        tot_energy = tot_energy/1000.0
    
        current_empty_weight = vehicle.Mass_Props.m_empty
        battery_weight_needed = tot_energy/battery_density
        
        mass_diff = (base_weight+battery_weight_needed) - current_empty_weight
        
        vehicle.Mass_Props.m_empty = base_weight + battery_weight_needed
        vehicle.Mass_Props.m_takeoff = base_weight + battery_weight_needed
        vehicle.Mass_Props.m_full = base_weight + battery_weight_needed + 1000.0
...
def define_vehicle():
    ...
    if n_select == 0:
        ...
        vehicle.Mass_Props.m_full       = 39060    # kg
        vehicle.Mass_Props.m_empty      = 39060    # kg
        vehicle.Mass_Props.m_takeoff    = 39060    # kg          
    # mass properties
...
def define_mission(vehicle):
    ...
    segment.mach       = 1.4
    segment.distance   = 400.0 * Units.nmi
