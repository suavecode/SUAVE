...
def full_setup(additional_drag_coefficient):

    vehicle = vehicle_setup(additional_drag_coefficient) # imported from E190 test script
...
def vehicle_setup(additional_drag_coefficient):
    ...
    aerodynamics.configuration.drag_coefficient_increment = additional_drag_coefficient
