...
#   Main
# ----------------------------------------------------------------------
def full_setup(inputs):

    vehicle = vehicle_setup(inputs)
...
def vehicle_setup():
    ...
    vehicle.mass_properties.payload                   = 11792.
    ...
    # basic parameters
    vehicle.reference_area         = inputs[0]
    ...
    wing.sweep                   = inputs[1]
    wing.thickness_to_chord      = inputs[2]
    wing.taper                   = 0.16
    ...
    turbofan.thrust.design                 = inputs[3]
...
def mission_setup(vehicle):
    ...
    #airport SL, ISA (for MTOW evaluation)
    ...
    # Short field airport (for range evaluation)
    ...
    airport_short_field.field_lenght = 1495. * Units.m
    ...
    # Mission range for fuel consumption evaluation
