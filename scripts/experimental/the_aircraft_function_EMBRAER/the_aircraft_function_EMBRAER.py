...
def evaluate_mission_for_fuel(vehicle,mission,results):
    ...
    from SUAVE.Methods.Performance import size_fuel_weight_given_mission_range
    from SUAVE.Methods.Performance import evaluate_mission

    # call function
    distance,fuel,tow = size_fuel_weight_given_mission_range(vehicle,mission,cruise_segment_tag,mission_payload,target_range)
