...
## @defgroup Plots-Performance
def plot_propeller_performance(prop, title=None, save_figure=False, save_filename='Propeller_Performance', file_type=".png"):
    # unpack
...
## @defgroup Plots-Performance  
def plot_propeller_disc_performance(prop,outputs,i=0,title=None,save_figure=False):
    """
    Inputs
