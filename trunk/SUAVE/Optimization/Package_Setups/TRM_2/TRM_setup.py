...
def TRM_Solve(problem,solver='SNOPT',FD='single', sense_step=1.0E-6,  nonderivative_line_search=False):
   
    # Have the optimizer call the wrapper
    mywrap = lambda x:TRM_Problem(problem,x)
