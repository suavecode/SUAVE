...
def write(vehicle,tag):
    ...
    for wing in vehicle.wings:
        ...
        for i_segs in xrange(1,n_segments):
            # Unpack thing
            #for some reason, indexing on sweep and dihedral works differently
            #dihedral_i = wing.Segments[i_segs-1].dihedral_outboard / Units.deg
            dihedral_i = wing.Segments[i_segs].dihedral_outboard / Units.deg
            ...
            sweep_i    = wing.Segments[i_segs].sweeps.quarter_chord / Units.deg
