...
class OrderedBunch(OrderedDict):
    ...
    def __new__(cls,*args,**kwarg):
        inst = OrderedDict.__new__(cls,*args,**kwarg)
        OrderedDict.__init__(inst,*args,**kwarg)
    ...
    def __getitem__(self,k):
        try:
            return OrderedDict.__getitem__(self,k).__get__(self,type(self))
        except:
            return OrderedDict.__getitem__(self,k)
    
    def __setitem__(self,k,v):
        try:
            OrderedDict.__getitem__(self,k).__set__(self,v)
        except:
            OrderedDict.__setitem__(self,k,v)
    
    def __delitem__(self,k):
        try:
            OrderedDict.__getitem__(self,k).__del__(self)
        except:
