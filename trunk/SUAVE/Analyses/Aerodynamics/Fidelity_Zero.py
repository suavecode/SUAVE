...
class Fidelity_Zero(Markup):
    ...
    def initialize(self):
        ...
        bemt_wake_model           = self.settings.use_bemt_wake_model
        ...
        self.process.compute.lift.inviscid_wings.initialize(use_surrogate,n_sw,n_cw,propeller_wake_model,bemt_wake_model,ito,wdt,nwts,mf )
