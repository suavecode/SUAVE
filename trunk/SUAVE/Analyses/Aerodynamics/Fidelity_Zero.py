...
class Fidelity_Zero(Markup):
    ...
    def initialize(self):
        ...
        prop_wake_model            = self.settings.prop_wake_model
        ...
        self.process.compute.lift.inviscid_wings.initialize(use_surrogate,vortex_distribution_flag,n_sw,n_cw,prop_wake_model)          
