...
## @ingroup Analyses-Mission-Segments-Hover
class Ground_Constant_Time(Aerodynamic):
    ...
    def __defaults__(self):
        ...
        initialize.conditions              = Methods.Ground.Common_Constant_Time.initialize_conditions        
        ...
        iterate.unknowns.mission           = Methods.Ground.Common_Constant_Time.unpack_unknowns
        ...
        iterate.conditions.forces_ground   = Methods.Ground.Common_Constant_Time.compute_ground_forces
        iterate.conditions.forces          = Methods.Ground.Common_Constant_Time.compute_forces
        iterate.conditions.planet_position = Methods.Common.Frames.update_planet_position
    
        # Solve Residuals
        iterate.residuals = Process()     
        iterate.residuals.total_forces     = Methods.Ground.Common_Constant_Time.solve_residuals
