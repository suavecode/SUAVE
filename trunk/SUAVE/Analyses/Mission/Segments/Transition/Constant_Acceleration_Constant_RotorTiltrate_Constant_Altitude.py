...
## @ingroup Analyses-Mission-Segments-Transition
class Constant_Acceleration_Constant_RotorTiltrate_Constant_Altitude(Aerodynamic):
    ...
    def __defaults__(self):
        ...
        self.tilt_initial       = None
        self.tilt_final         = 0.0 * Units['rad']
        ...
        initialize.conditions              = Methods.Transition.Constant_Acceleration_Constant_RotorTiltrate_Constant_Altitude.initialize_conditions
        ...
        iterate.residuals.total_forces     = Methods.Transition.Constant_Acceleration_Constant_RotorTiltrate_Constant_Altitude.residual_total_forces
