...
class Constant_Acceleration_Constant_RotorPitchRate_Constant_Altitude(Aerodynamic):
    ...
    def __defaults__(self):
        ...
        self.rotor_y_axis_rotation_initial  = None  # Initial Rotor Pitch
        self.rotor_y_axis_rotation_final    = 0.0 * Units['rad']
        ...
        initialize.conditions              = Methods.Transition.Constant_Acceleration_Constant_RotorPitchRate_Constant_Altitude.initialize_conditions
