...
class Fixed_Conditions(Aerodynamic):
    ...
    def __defaults__(self):
        ...
        self.state.unknowns.x_accel    = ones_row(1) * 0.0
        self.state.unknowns.z_accel    = ones_row(1) * 0.0
        ...
        initialize.conditions              = Methods.Single_Point.Fixed_Conditions.initialize_conditions
        ...
        iterate.unknowns.mission           = Methods.Single_Point.Fixed_Conditions.unpack_unknowns
        ...
        iterate.conditions.weights         = Methods.Single_Point.Fixed_Conditions.update_weights
