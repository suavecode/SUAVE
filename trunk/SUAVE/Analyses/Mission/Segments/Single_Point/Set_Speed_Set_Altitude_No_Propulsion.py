...
## @ingroup Analyses-Mission-Segments-Single_Point
class Set_Speed_Set_Altitude_No_Propulsion(Aerodynamic):
    ...
    def __defaults__(self):
        ...
        initialize.conditions              = Methods.Single_Point.Set_Speed_Set_Altitude_No_Propulsion.initialize_conditions
        ...
        iterate.unknowns.mission           = Methods.Single_Point.Set_Speed_Set_Altitude_No_Propulsion.unpack_unknowns
        ...
        iterate.residuals.total_forces     = Methods.Single_Point.Set_Speed_Set_Altitude_No_Propulsion.residual_total_force
