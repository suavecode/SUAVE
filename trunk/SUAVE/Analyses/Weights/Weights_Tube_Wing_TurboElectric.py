...
# Weights_Tube_Wing_TurboElectric.py
#
...
## @ingroup Analyses-Weights
class Weights_Tube_Wing_TurboElectric(Weights):
    """ This is class that evaluates the weight of Tube and Wing aircraft equipped with a turboelectric powertrain
    ...
    def evaluate(self,conditions=None):
        ...
        empty    = SUAVE.Methods.Weights.Correlations.Tube_Wing_TurboElectric.empty
