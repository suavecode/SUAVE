...
def update_wake_position_time_marching(wake, rotor, conditions):  
    ...
    for i in range(nts-1):
        ...
        interpolatedBoxData = single_step_time_march(wake, WD, VD, new_wake, use_exact_velocities,rotor, conditions, step_1_times, i, debug, Na, nts, step_2_times, ctrl_pts, dt)
