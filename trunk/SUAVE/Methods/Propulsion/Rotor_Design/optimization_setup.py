...
def optimization_setup(rotor,number_of_stations,print_iterations):
    ...
    # ------------------------------------------------------------------- 
    aliases = [] 
    aliases.append([ 'chord_r'                    , 'vehicle_configurations.*.networks.battery_rotor.rotors.rotor.chord_r' ])
    aliases.append([ 'chord_p'                    , 'vehicle_configurations.*.networks.battery_rotor.rotors.rotor.chord_p' ])
    aliases.append([ 'chord_q'                    , 'vehicle_configurations.*.networks.battery_rotor.rotors.rotor.chord_q' ])
    aliases.append([ 'chord_t'                    , 'vehicle_configurations.*.networks.battery_rotor.rotors.rotor.chord_t' ]) 
    aliases.append([ 'twist_r'                    , 'vehicle_configurations.*.networks.battery_rotor.rotors.rotor.twist_r' ])
    aliases.append([ 'twist_p'                    , 'vehicle_configurations.*.networks.battery_rotor.rotors.rotor.twist_p' ])
    aliases.append([ 'twist_q'                    , 'vehicle_configurations.*.networks.battery_rotor.rotors.rotor.twist_q' ])
    aliases.append([ 'twist_t'                    , 'vehicle_configurations.*.networks.battery_rotor.rotors.rotor.twist_t' ])  
    aliases.append([ 'twist_0'                    , 'vehicle_configurations.*.networks.battery_rotor.rotors.rotor.twist_0' ])      
    aliases.append([ 'hover_tip_mach'             , 'vehicle_configurations.hover.networks.battery_rotor.rotors.rotor.hover.design_tip_mach' ]) 
    ...
    aliases.append([ 'OEI_collective_pitch'       , 'vehicle_configurations.oei.networks.battery_rotor.rotors.rotor.inputs.pitch_command' ]) 
    aliases.append([ 'OEI_tip_mach'               , 'vehicle_configurations.oei.networks.battery_rotor.rotors.rotor.oei.design_tip_mach' ]) 
    if nexus.prop_rotor_flag: 
        aliases.append([ 'cruise_tip_mach'        , 'vehicle_configurations.cruise.networks.battery_rotor.rotors.rotor.cruise.design_tip_mach' ])  
        aliases.append([ 'cuise_collective_pitch' , 'vehicle_configurations.cruise.networks.battery_rotor.rotors.rotor.inputs.pitch_command' ])  
