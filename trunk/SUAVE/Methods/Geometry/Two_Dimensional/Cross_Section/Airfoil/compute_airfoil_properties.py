...
def compute_airfoil_properties(airfoil_geometry, airfoil_polars = None, boundary_layer_files = None ,use_pre_stall_data=True):
    ...
    #for af in range(num_airfoils): 
        ...
        ## create surrogates  
        #cm_surs[airfoil_geometry.name[af] + '_ls']                       = RegularGridInterpolator((AoA_sweep, Re_sweep),cm[af] ,bounds_error=False,fill_value=None  ) 
        #theta_lower_surface_surs[airfoil_geometry.name[af] + '_ls']      = RegularGridInterpolator((AoA_sweep, Re_sweep),theta_lower_surface[af] ,bounds_error=False,fill_value=None  ) 
        #delta_lower_surface_surs[airfoil_geometry.name[af]+ '_ls']       = RegularGridInterpolator((AoA_sweep, Re_sweep),delta_lower_surface[af] ,bounds_error=False,fill_value=None  ) 
        #delta_star_lower_surface_surs[airfoil_geometry.name[af]+ '_ls']  = RegularGridInterpolator((AoA_sweep, Re_sweep),delta_star_lower_surface[af],bounds_error=False,fill_value=None  ) 
        #sa_lower_surface_surs[airfoil_geometry.name[af]+ '_ls']          = RegularGridInterpolator((AoA_sweep, Re_sweep),sa_lower_surface[af] ,bounds_error=False,fill_value=None)   
        #ue_lower_surface_surs[airfoil_geometry.name[af]+ '_ls']          = RegularGridInterpolator((AoA_sweep, Re_sweep),ue_lower_surface[af] ,bounds_error=False,fill_value=None) 
        #cf_lower_surface_surs[airfoil_geometry.name[af]+ '_ls']          = RegularGridInterpolator((AoA_sweep, Re_sweep),cf_lower_surface[af] ,bounds_error=False,fill_value=None) 
        #Ret_lower_surface_surs[airfoil_geometry.name[af]+ 'ls']          = RegularGridInterpolator((AoA_sweep, Re_sweep),Ret_lower_surface[af],bounds_error=False,fill_value=None  ) 
        #H_lower_surface_surs[airfoil_geometry.name[af]+ '_ls']           = RegularGridInterpolator((AoA_sweep, Re_sweep),H_lower_surface[af]  ,bounds_error=False,fill_value=None)
        #theta_upper_surface_surs[airfoil_geometry.name[af]+ '_us']       = RegularGridInterpolator((AoA_sweep, Re_sweep),theta_upper_surface[af] ,bounds_error=False,fill_value=None ) 
        #delta_upper_surface_surs[airfoil_geometry.name[af]+ '_us']       = RegularGridInterpolator((AoA_sweep, Re_sweep),delta_upper_surface[af]  ,bounds_error=False,fill_value=None) 
        #delta_star_upper_surface_surs[airfoil_geometry.name[af]+ '_us']  = RegularGridInterpolator((AoA_sweep, Re_sweep),delta_star_upper_surface[af] ,bounds_error=False,fill_value=None ) 
        #sa_upper_surface_surs[airfoil_geometry.name[af]+ '_us']          = RegularGridInterpolator((AoA_sweep, Re_sweep),sa_upper_surface[af] ,bounds_error=False,fill_value=None )   
        #ue_upper_surface_surs[airfoil_geometry.name[af]+ '_us']          = RegularGridInterpolator((AoA_sweep, Re_sweep),ue_upper_surface[af] ,bounds_error=False,fill_value=None ) 
        #cf_upper_surface_surs[airfoil_geometry.name[af]+ '_us']          = RegularGridInterpolator((AoA_sweep, Re_sweep),cf_upper_surface[af] ,bounds_error=False,fill_value=None ) 
        #Ret_upper_surface_surs[airfoil_geometry.name[af]+ '_us']         = RegularGridInterpolator((AoA_sweep, Re_sweep),Ret_upper_surface[af],bounds_error=False,fill_value=None  ) 
        #H_upper_surface_surs[airfoil_geometry.name[af]+ '_us']           = RegularGridInterpolator((AoA_sweep, Re_sweep),H_upper_surface[af]  ,bounds_error=False,fill_value=None)  
    ...
    # AERODAS 
    for i in range(num_airfoils):  
        aoa_data           = AoA_sweep_deg*Units.degrees 
        if airfoil_polars != None:  
            # read airfoil polars 
    ...
    airfoil_data.angle_of_attacks              = aoa_data 
