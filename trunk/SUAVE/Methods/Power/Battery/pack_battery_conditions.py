...
def pack_battery_conditions(conditions,battery,avionics_payload_power,P): 
    ...
    conditions.propulsion.battery.pack_temperature             = battery.pack_temperature  
    ...
    conditions.propulsion.battery.cell_power_draw              = battery.inputs.power_in /n_series
    conditions.propulsion.battery.cell_energy                  = battery.current_energy/n_total   
    conditions.propulsion.battery.cell_voltage_under_load      = battery.cell_voltage_under_load    
    conditions.propulsion.battery.cell_voltage_open_circuit    = battery.cell_voltage_open_circuit  
    conditions.propulsion.battery.cell_current                 = abs(battery.cell_current)        
    conditions.propulsion.battery.cell_temperature             = battery.cell_temperature
    conditions.propulsion.battery.cell_charge_throughput       = battery.cell_charge_throughput
    conditions.propulsion.battery.cell_heat_energy_generated   = battery.heat_energy_generated
    conditions.propulsion.battery.cell_joule_heat_fraction     = battery.cell_joule_heat_fraction   
    conditions.propulsion.battery.cell_entropy_heat_fraction   = battery.cell_entropy_heat_fraction 
