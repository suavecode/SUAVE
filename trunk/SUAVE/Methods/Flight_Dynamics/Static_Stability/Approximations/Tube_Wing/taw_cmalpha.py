...
def taw_cmalpha(geometry,mach,conditions,configuration):
    ...
    sweep = geometry.wings['main_wing'].sweep.quarter_chord
...
if __name__ == '__main__':
    ...
    wing.sweep.leading_edge        = 42.0   * Units.deg # Leading edge
    ...
    wing.sweep.leading_edge = 44.0   * Units.deg # leading edge
    wing.taper               = 7.5/32.6
    wing.aspect_ratio        = wing.spans.projected**2/wing.areas.reference
