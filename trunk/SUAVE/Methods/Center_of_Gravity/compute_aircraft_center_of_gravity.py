...
def compute_aircraft_center_of_gravity(vehicle, nose_load_fraction=.06):
        ...
        if vehicle.fuselages['fuselage']:  # configurations with fuselages (BWB, Tube and Wing)
        ...
        else:   #Configurations without Fuselages 
                sum_moments              = (wing_moment+h_tail_moment+v_tail_moment+control_systems_moment+ propulsor_moment+ fuel_moment)
