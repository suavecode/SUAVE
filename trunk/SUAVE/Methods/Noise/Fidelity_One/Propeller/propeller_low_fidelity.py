...
def propeller_low_fidelity(propeller,segment, mic_loc, harmonic_test ):
    ...
    SPL_GD_unweighted      = np.zeros(ctrl_pts)
    ...
    for i in range(ctrl_pts):   
        ...
        if harmonic_test.any(): 
            ...
            SPL_GD_unweighted[i]      = pressure_ratio_to_SPL_arithmetic(total_p_pref_r_GD)
            SPL_BM_unweighted[i]      = pressure_ratio_to_SPL_arithmetic(total_p_pref_r_BM)
            SPL_H_unweighted[i]       = pressure_ratio_to_SPL_arithmetic(total_p_pref_r_H)  
            #SPL_v_unweighted[i]       = SPL_v
        
        # A- Weighted Rotational and Vortex SPL 
        SPL_GDv_dBA[i]      = pressure_ratio_to_SPL_arithmetic(total_p_pref_GDv_dBA)
        SPL_BMv_dBA[i]      = pressure_ratio_to_SPL_arithmetic(total_p_pref_BMv_dBA)
        SPL_Hv_dBA[i]       = pressure_ratio_to_SPL_arithmetic(total_p_pref_Hv_dBA)
    
    # append SPL of source
    results = Data()
    results.SPL_GD_unweighted = SPL_GD_unweighted
    results.SPL_BM_unweighted = SPL_BM_unweighted
    results.SPL_H_unweighted  = SPL_H_unweighted 
    results.SPL_v_unweighted  = SPL_v_unweighted 
    results.SPL_GDv_dBA       = SPL_GDv_dBA      
    results.SPL_BMv_dBA       = SPL_BMv_dBA      
    results.SPL_Hv_dBA        = SPL_Hv_dBA       
    results.SPL_v_dBA         = SPL_v_dBA     
