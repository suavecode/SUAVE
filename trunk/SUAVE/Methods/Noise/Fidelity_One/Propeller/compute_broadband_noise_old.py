...
# ----------------------------------------------------------------------
## @ingroupMethods-Noise-Fidelity_One-Propeller
def compute_broadband_noise_old(freestream,angle_of_attack,blade_section_position_vectors,velocity_vector,network,auc_opts,settings,res,source):
    ...
    x              = blade_section_position_vectors.blade_section_coordinate_sys[:,:,:,0,0,0,0,0]                               
    y              = blade_section_position_vectors.blade_section_coordinate_sys[:,:,:,0,0,0,1,0]
    z              = blade_section_position_vectors.blade_section_coordinate_sys[:,:,:,0,0,0,2,0]                                    
