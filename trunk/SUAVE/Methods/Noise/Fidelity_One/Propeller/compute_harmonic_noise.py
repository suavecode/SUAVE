...
def compute_harmonic_noise(harmonics,freestream,angle_of_attack,position_vector,
    ...
    Inputs: 
        ...
        rotors                        - rotor class data structure                                                 [None]
    ...
    alpha          = np.tile((angle_of_attack  + rotor.orientation_euler_angles[1])[:,:,None,None,None],(1,num_mic,num_rot,num_r,num_h))           
    ...
    omega          = np.tile(auc_opts.omega[:,:,None,None,None],(1,num_mic,num_rot,num_r,num_h))     # angular velocity       
    dT_dr          = np.tile(auc_opts.blade_dT_dr[:,None,None,:,None],(1,num_mic,num_rot,1,num_h))   # nondimensionalized differential thrust distribution 
    dQ_dr          = np.tile(auc_opts.blade_dQ_dr[:,None,None,:,None],(1,num_mic,num_rot,1,num_h))   # nondimensionalized differential torque distribution
    ...
    # phi angle relative to rotor shaft axis
