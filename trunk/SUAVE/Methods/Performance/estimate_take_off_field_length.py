...
def estimate_take_off_field_length(vehicle,analyses,airport,compute_2nd_seg_climb = 0,
                                   maximum_lift_method='Fidelity_Zero'):
    ...
    if maximum_lift_method == 'Fidelity_Zero':
        ...
        # Condition to CLmax calculation: 90KTAS @ 10000ft, ISA
        conditions  = atmo.compute_values(10000. * Units.ft)     
        mach_number = 90. * Units.knots / conditions.speed_of_sound
        ...
        raise NotImplementedError('Chosen maximum lift method is not implemented.')
