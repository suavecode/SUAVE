...
class Settings(Data):
        ...
        def __defaults__(self):
                ...
                self.filenames.avl_bin_name              = '/Users/matthewclarke/Documents/AVL/avl3.35'  # to call avl from command line. If avl is not on the system path, include absolute path to the avl binary i.e. '/your/path/to/avl'
