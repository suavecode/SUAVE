...
from SUAVE.Methods.Aerodynamics.Common.Fidelity_Zero.Helper_Functions.asymmetry_drag import asymmetry_drag
...
def engine_out(state,settings,geometry):
    ...
    if engine_out_flag:
        ...
        asym_drag_coef = asymmetry_drag(state, geometry, windmilling_drag_coefficient=windmilling_drag_coefficient)
