...
def total_aircraft(state,settings,geometry):
    ...
    engine_out_drag            = conditions.aerodynamics.drag_breakdown.engine_out_drag

    aircraft_total_drag = 0.0
    # Add drag_coefficient_increment
    aircraft_total_drag += trim_corrected_drag + drag_coefficient_increment + spoiler_drag + engine_out_drag
