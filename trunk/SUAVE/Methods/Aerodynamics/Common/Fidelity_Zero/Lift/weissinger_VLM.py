    ...
    for wing in geometry.wings.values():
        ...
        if orientation == False:
            ...
            if n_segments>0:
                ...
                ya = ya + wing_origin[1] # y coordinate of start of horseshoe vortex on panel
                yb = yb + wing_origin[1] # y coordinate of end horseshoe vortex on panel
                xa = xa + wing_origin[0] # x coordinate of horseshoe vortex on panel
                ...
                ya = (i)*deltax + wing_origin[1]                                                   # y coordinate of start of horseshoe vortex on panel
                yb = (i+1)*deltax + wing_origin[1]                                                 # y coordinate of end horseshoe vortex on panel
                xa = ((i+1)*deltax-deltax/2)*np.tan(sweep) + 0.25*section_length + wing_origin[0]  # x coordinate of horseshoe vortex on panel
                x  = ((i+1)*deltax-deltax/2)*np.tan(sweep) + 0.75*section_length + wing_origin[0]  # x coordinate of control points on panel
                y  = ((i+1)*deltax-deltax/2) + wing_origin[1]                                      # y coordinate of control points on panel 
                               
                rhs = np.sin(twist_distri+aoa)                                  
