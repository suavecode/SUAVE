...
def generate_wing_vortex_distribution(VD,wing,n_cw,n_sw,spc,precision):
    ...
    for i_break in range(n_breaks):   
        ...
        if span_breaks[i_break].Airfoil: 
            ...
            break_camber_zs.append(airfoil_geo_data.camber_coordinates[airfoil_geo_data.airfoil_names[0]])
            break_camber_xs.append(airfoil_geo_data.x_lower_surface[airfoil_geo_data.airfoil_names[0]]) 
        else:
