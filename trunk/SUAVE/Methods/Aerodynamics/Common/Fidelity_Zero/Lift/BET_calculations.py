...
def compute_airfoil_aerodynamics(beta,c,r,R,B,Wa,Wt,a,nu,a_loc,a_geo,cl_sur,cd_sur,ctrl_pts,Nr,Na,tc):
    ...
    Cl, Cdval = lax.cond(a_loc != None, compute_surrogate,compute_DAE, alpha, Re, Ma, tc, a_loc, Wa, cl_sur, cd_sur)
...
def compute_DAE(alpha,Re,Ma,tc,a_loc,Wa,cl_sur,cd_sur):
...
def compute_surrogate(alpha,Re,Ma,tc,a_loc,Wa,cl_sur,cd_sur):
