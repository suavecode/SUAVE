...
from SUAVE.Methods.Aerodynamics.Drag.Correlations import \
     parasite_drag_aircraft_supersonic, induced_drag_aircraft, compressibility_drag_total_supersonic, \
     miscellaneous_drag_aircraft, induced_drag_aircraft_supersonic, compressibility_drag_wing
