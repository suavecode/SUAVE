...
""" vlm(wing,segment,Sref,alpha,n,nn)
    """
...
def Weissinger_vortex_lattice(Wing,segment,Sref,alpha,n,nn):
#def vlm(span,root_chord,tip_chord,n,nn,sweep,taper,alpha_rc,alpha_tc,Vinf,Sref,rho,sym_para,Mc,aoa,AR):
    """ SUAVE.Methods.Aerodynamics.Pass_fidelity.vlm(aircraft,segment,Cl,cdi_inv,cdp,fd_ws)
        ...
        Inputs:
            ...
            n -  no of panels in y direction (variable name correct)
...
#process    
   ...
   #switch for compressibility correction maybe as part of aerofid1 initialization   
