...
def compute_max_lift_coeff(vehicle,conditions=None):
    ...
    for wing in vehicle.wings:
        ...
        sweep      = wing.sweep.quarter_chord # convert into degrees
        taper      = wing.taper
...
if __name__ == '__main__':
    ...
    wing.sweep.quarter_chord     = 22. * Units.deg
    wing.symmetric               = True
    ...
    wing.sweep.quarter_chord     = 34.5 * Units.deg
    wing.symmetric               = True
    wing.thickness_to_chord      = 0.11
    ...
    wing.sweep.quarter_chord     = 35. * Units.deg
