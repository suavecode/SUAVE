...
def initialize_conditions(segment):
    ...
    T0  = segment.rotor_y_axis_rotation_initial
    Tf  = segment.rotor_y_axis_rotation_final  
    ...
    if T0 is None:
        ...
        segment.rotor_y_axis_rotation_initial = T0    
    ...
    # set the rotor angles
    if Tf > T0:
        rotor_angle = T0 + time*(Tf-T0)/(t_final-t_initial)
    else:
        rotor_angle = T0 - time*(T0-Tf)/(t_final-t_initial)
    segment.state.conditions.propulsion.y_axis_rotation = rotor_angle[:,0]     
