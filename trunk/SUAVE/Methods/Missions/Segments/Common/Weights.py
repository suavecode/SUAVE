...
def update_weights(segment):
    ...
    mdot_cryogen    = conditions.weights.vehicle_cryogen_rate
    mf0             = conditions.weights.fuel_mass[0,0]
    mc0             = conditions.weights.cryogen_mass[0,0]
    ...
    conditions.weights.cryogen_mass[1:,0]                   = mc[1:,0]
