...
def empty(vehicle):
    ...
    if not vehicle.wings.has_key('main_wing'):
        ...
        sweep_w    = vehicle.wings['main_wing'].sweep.quarter_chord
    ...
    if not vehicle.wings.has_key('horizontal_stabilizer'):
        ...
        sweep_h        = vehicle.wings['horizontal_stabilizer'].sweep.quarter_chord
    ...
    if not vehicle.wings.has_key('vertical_stabilizer'):   
        ...
        sweep_v    = vehicle.wings['vertical_stabilizer'].sweep.quarter_chord
