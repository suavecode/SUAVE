...
def big_integral(x, A, B, C):
    ...
    results = (1 / (4 * B ** 3)) * (2 * A ** 2 * np.pi * x + 4 * A * B * C * np.pi * x +
                                    B ** 2 * (-1 + 2 * C ** 2) * np.pi * x -
                                    2 * (2 * A ** 2 + 4 * A * B * C + B ** 2 * (-1 + 2 * C ** 2)) * np.sqrt(
                1 - x ** 2) +
                                    2 / 3 * B * np.sqrt(1 - x ** 2) * (3 * A * x + B * (-1 + 3 * C * x + x ** 2)) +
                                    2 * B * (A + B * C) * np.arcsin(x) -
                                    2 * (2 * A ** 2 + 4 * A * B * C + B ** 2 * (-1 + 2 * C ** 2)) * x * np.arcsin(x) - (
                                            4 * (A + B * C) ** 2 * np.sqrt(
                                        0j + -A ** 2 - 2 * A * B * C - B ** 2 * (-1 + C ** 2)) *
                                            np.log(A + B * C - B * x)) / B - (
                                            4 * (A ** 3 + 3 * A ** 2 * B * C + B ** 3 * C * (
                                            -1 + C ** 2) + A * B ** 2 * (-1 + 3 * C ** 2)) * x * np.log(
                                        A + B * C - B * x)) / np.sqrt(
                0j + -A ** 2 - 2 * A * B * C - B ** 2 * (-1 + C ** 2)) + (
                                            8 * (A + B * C) ** 2 * np.sqrt(
                                        0j - A ** 2 - 2 * A * B * C - B ** 2 * (-1 + C ** 2)) *
                                    ...
                                    B + (4 * (A ** 3 + 3 * A ** 2 * B * C + B ** 3 * C * (-1 + C ** 2) +
                                              A * B ** 2 * (-1 + 3 * C ** 2)) * x * np.log(0j - B + A * x + B * C * x -
                                                                                           np.sqrt(
                                                                                               0j + -A ** 2 + B ** 2 - 2 * A * B * C - B ** 2 * C ** 2) * np.sqrt(
                1 - x ** 2))) / (np.sqrt(0j - A ** 2 - 2 * A * B * C - B ** 2 * (-1 + C ** 2))) - (1 / B) *
                                    4 * (A + B * C) ** 2 * np.sqrt(
                0j - A ** 2 - 2 * A * B * C - B ** 2 * (-1 + C ** 2)) *
                                    np.log(-B + A * x + B * C * x +
                                           np.sqrt(0j - A ** 2 + B ** 2 - 2 * A * B * C - B ** 2 * C ** 2) * np.sqrt(
                                        1 - x ** 2)) + (1 / B) * 4 * (A + B * C) * np.sqrt(
                0j - (A ** 2 + 2 * A * B * C + B ** 2 * (-1 + C ** 2)) ** 2) * np.log(
                A ** 2 * x + 2 * A * B * C * x + B ** 2 * (-1 + C ** 2) * x +
