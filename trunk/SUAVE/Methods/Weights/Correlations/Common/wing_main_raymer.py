...
## @ingroup Methods-Weights-Correlations-Common 
def wing_main_raymer(wing,Nult,TOW,wt_zf,rho,sigma,area_fraction=1):
    ...
    Wwing = 0.0051 * (Wdg*Nz)**.557 * Sw**.649 * A**.5 * tc_root**-.4 * (1+taper)**.1 * np.cos(sweep)**-1. * Scsw**.1
    Wwing = 0.0051 * (Wdg*Nz)**.557 * Sw**.649 * A**.5 * tc_root**-.4 * (1+taper)**.1 * Scsw**.1
