...
def empty(vehicle,settings=None):
    ...
    if propulsor_name=='turbofan' or propulsor_name=='Turbofan':
        ...
        wt_leads        = wt_hts_dynamo
        wt_ccs          = wt_dynamo_esc
        # --------------- Current Supply HTS Dynamo ends --------
    ...
    output.propulsion_breakdown.hts_dynamo      = wt_hts_dynamo
    output.propulsion_breakdown.dynamo_esc      = wt_dynamo_esc
