## @ingroup Methods-Weights-Correlations-Tube_Wing_TurboElectric
# empty.py
# 
...
def empty(vehicle,settings=None):
    ...
    if propulsor_name=='turbofan' or propulsor_name=='Turbofan':
        ...
        # This first bit is copied directly from the turbofan empty.py. It is assumed an electrofan with the same diameter as a turbojet will produce the same thrust. Likely the turbofan will produce slightly more as some thrust will be produced directly from the engine core, however the elctrofan will likley have a smaller core, resulting in more thrust directly from the fan.
