...
class Ducted_Fan_FC(Propulsor):
    ...
    def engine_sizing_ductedfan(self,State, fuelcell):    
 ...
 ###############################################################################################################################       
        ...
        mdot = RunFuelCell(fuelcell,State, Pfc)[0]
        Isp = FD/(mdot*State.g0)
