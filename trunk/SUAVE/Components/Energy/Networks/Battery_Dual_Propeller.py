...
## @ingroup Components-Energy-Networks
class Battery_Dual_Propeller(Propulsor):
    ...
    def __defaults__(self):
        ...
        self.tag                         = 'Battery_Dual_Propeller'
    ...
    def unpack_unknowns_high_lift(self,segment):
    ...
    def unpack_unknowns_cruise(self,segment):
        """ This is an extra set of unknowns which are unpacked from the mission solver and send to the network.
            ...
            state.unknowns.propeller_power_coefficient [None]
            state.unknowns.battery_voltage_under_load    [volts]
            state.unknowns.throttle_2                    [0-1]
            state.unknowns.throttle                      [0-1]
    
            Outputs:
            state.conditions.propulsion.propeller_power_coefficient [None]
            state.conditions.propulsion.battery_voltage_under_load    [volts]
            state.conditions.propulsion.throttle_2                    [0-1]
            state.conditions.propulsion.throttle                      [0-1]
        ...
        return              
    def residuals_high_lift(self,segment):
