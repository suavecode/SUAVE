...
class Turbofan_TASOPT_Net(Propulsor):
    ...
    def unpack_unknowns(self,segment):
        """ This is an extra set of unknowns which are unpacked from the mission solver and send to the network.
            ...
            Inputs:
            segment.state.unknowns.fan_pressure_ratio [None]
            segment.state.unknowns.lpc_pressure_ratio [None]
            segment.state.unknowns.hpc_pressure_ratio [None]
            segment.state.unknowns.fan_mass_flow [None] Corrected mass flow
            segment.state.unknowns.lpc_mass_flow [None] Corrected mass flow
            segment.state.unknowns.hpc_mass_flow [None] Corrected mass flow
            segment.state.unknowns.burner_exit_total_temperature [K]
            segment.state.unknowns.core_nozzle_total_pressure [Pa]
    
            Outputs:
            segment.state.conditions.propulsion.fan_pressure_ratio [None]
            segment.state.conditions.propulsion.lpc_pressure_ratio [None]
            segment.state.conditions.propulsion.hpc_pressure_ratio [None]
            segment.state.conditions.propulsion.fan_mass_flow [None]
            segment.state.conditions.propulsion.lpc_mass_flow [None]
            segment.state.conditions.propulsion.hpc_mass_flow [None]
            segment.state.conditions.propulsion.burner_exit_total_temperature [K]
            segment.state.conditions.propulsion.core_nozzle_total_pressure [Pa]
        ...
        segment.state.conditions.propulsion.fan_pressure_ratio              = segment.state.unknowns.fan_pressure_ratio
        segment.state.conditions.propulsion.lpc_pressure_ratio              = segment.state.unknowns.lpc_pressure_ratio
        segment.state.conditions.propulsion.hpc_pressure_ratio              = segment.state.unknowns.hpc_pressure_ratio
        segment.state.conditions.propulsion.fan_mass_flow                   = segment.state.unknowns.fan_mass_flow
        segment.state.conditions.propulsion.lpc_mass_flow                   = segment.state.unknowns.lpc_mass_flow
        segment.state.conditions.propulsion.hpc_mass_flow                   = segment.state.unknowns.hpc_mass_flow
        segment.state.conditions.propulsion.burner_exit_total_temperature   = segment.state.unknowns.burner_exit_total_temperature
        segment.state.conditions.propulsion.core_nozzle_total_pressure      = segment.state.unknowns.core_nozzle_total_pressure
