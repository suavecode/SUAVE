...
# Vehicle.py
#
# Created:  ### 2013, SUAVE Team (Stanford University)
# Modified: ### ####, M. Vegh
#           Feb 2016, E. Botero
#           Apr 2017, M. Clarke 
#           Apr 2020, E. Botero
...
from MARC import Components
from MARC.Components import Physical_Component
import numpy as np
...
## @ingroup Vehicle
class Vehicle(Data):
    """MARC Vehicle container class with database + input / output functionality
