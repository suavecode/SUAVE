...
from MARC.Plugins.pint import UnitRegistry
from MARC.Plugins.pint.quantity import _Quantity
...
""" MARC.Attributes.Units()
    ...
    Based on the Pint package, included in MARC.Plugins
