...
from MARC.Methods.Aerodynamics import Supersonic_Zero  as Methods
from MARC.Methods.Aerodynamics import OpenVSP_Wave_Drag as VSP_Methods
from MARC.Methods.Aerodynamics.Common import Fidelity_Zero as Common
...
class Supersonic_OpenVSP_Wave_Drag(Markup):
    ...
    def initialize(self):
        ...
        self.process.compute.lift.inviscid_wings.initialize(use_surrogate,n_sw,n_cw,propeller_wake_model,mf,mn)
