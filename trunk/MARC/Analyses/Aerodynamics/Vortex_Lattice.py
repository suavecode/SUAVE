...
class Vortex_Lattice(Aerodynamics):
    ...
    def __defaults__(self):
        ...
        self.training                                = Data()
        self.training.angle_of_attack                = np.array([[-75.,-45.,-5., -2. , 0.0 , 2.0, 5.0, 8.0, 10.0 , 12., 45., 75.]]).T * Units.deg 
    ...
    def sample_training(self):
        ...
        # Setup Konditions    
        konditions                              = MARC.Analyses.Mission.Segments.Conditions.Aerodynamics()
