...
from MARC.Methods.Propulsion.Rotor_Wake.Fidelity_One.fidelity_one_wake_convergence import fidelity_one_wake_convergence
...
class Rotor_Wake_Fidelity_One(Energy_Component):
    """ MARC.Analyses.Propulsion.Rotor_Wake_Fidelity_One()
