...
from MARC.Core import redirect

from MARC.Analyses.Mission.Segments.Conditions.Aerodynamics import Aerodynamics
from MARC.Analyses.Mission.Segments.Conditions.Conditions   import Conditions

from MARC.Methods.Aerodynamics.AVL.write_geometry           import write_geometry
from MARC.Methods.Aerodynamics.AVL.write_mass_file          import write_mass_file
from MARC.Methods.Aerodynamics.AVL.write_run_cases          import write_run_cases
from MARC.Methods.Aerodynamics.AVL.write_input_deck         import write_input_deck
from MARC.Methods.Aerodynamics.AVL.run_analysis             import run_analysis
from MARC.Methods.Aerodynamics.AVL.translate_data           import translate_conditions_to_cases, translate_results_to_conditions
from MARC.Methods.Aerodynamics.AVL.purge_files              import purge_files
from MARC.Methods.Aerodynamics.AVL.Data.Settings            import Settings
from MARC.Methods.Aerodynamics.AVL.Data.Cases               import Run_Case
from MARC.Methods.Geometry.Two_Dimensional.Planform.populate_control_sections import populate_control_sections  
from MARC.Methods.Flight_Dynamics.Dynamic_Stability.compute_dynamic_flight_modes import  compute_dynamic_flight_modes
...
# ----------------------------------------------------------------------
    ...
    def evaluate_conditions(self,run_conditions, trim_aircraft ):
        ...
        Inputs:
        run_conditions <MARC data type> aerodynamic conditions; until input
                method is finalized, will assume mass_properties are always as 
                defined in self.features

        Outputs:
        results        <MARC data type>
