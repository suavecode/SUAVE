...
from MARC.Analyses.Atmospheric import Atmospheric

from MARC.Attributes.Gases import Air
from MARC.Attributes.Planets import Earth

from MARC.Analyses.Mission.Segments.Conditions import Conditions

from MARC.Core import Units
from MARC.Core.Arrays import atleast_2d_col
...
class Constant_Temperature(Atmospheric):
    ...
    def __defaults__(self):
        ...
        atmo_data = MARC.Attributes.Atmospheres.Earth.Constant_Temperature()
