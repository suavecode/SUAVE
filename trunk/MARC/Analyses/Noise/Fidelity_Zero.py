...
# noise imports 
from MARC.Methods.Noise.Fidelity_Zero.Airframe.noise_airframe_Fink                               import noise_airframe_Fink
from MARC.Methods.Noise.Fidelity_Zero.Engine.noise_SAE                                           import noise_SAE  
from MARC.Methods.Noise.Certification.compute_certification_distance_and_emission_angles         import compute_certification_distance_and_emission_angles
from MARC.Methods.Noise.Common.decibel_arithmetic                                                import SPL_arithmetic
from MARC.Methods.Noise.Common.generate_microphone_points                                        import generate_zero_elevation_microphone_points
from MARC.Methods.Noise.Common.compute_relative_noise_evaluation_locations                       import compute_relative_noise_evaluation_locations 
...
class Fidelity_Zero(Noise):
    ...
    """ MARC.Analyses.Noise.Fidelity_Zero()
