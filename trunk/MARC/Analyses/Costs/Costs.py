...
class Costs(Analysis):
    ...
    def __defaults__(self):
        ...
        self.settings.operating_costs_method = \
            MARC.Methods.Costs.Correlations.Operating_Costs.compute_operating_costs
        self.settings.industrial_costs_method = \
            MARC.Methods.Costs.Correlations.Industrial_Costs.compute_industrial_costs
    ...
    def evaluate(self,conditions=None):
        ...
        Properties Used:
        self.
          vehicle                           MARC vehicle passed to the functions below
