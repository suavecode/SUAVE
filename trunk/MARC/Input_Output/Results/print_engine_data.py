...
# Created:  SUAVE Team (Stanford University)
...
def print_engine_data(vehicle, filename='engine_data.dat', units="imperial"):
    ...
    sea_level_gravity = MARC.Attributes.Planets.Earth().sea_level_gravity
    atmo = MARC.Analyses.Atmospheric.US_Standard_1976()  # mission.segments[0].atmosphere
