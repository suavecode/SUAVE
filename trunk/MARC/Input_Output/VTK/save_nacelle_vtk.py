...
from MARC.Visualization.Geometry.Three_Dimensional.plot_3d_nacelle import generate_3d_nacelle_points
...
def save_nacelle_vtk(nacelle, filename, Results, origin_offset):
    """
    Saves a MARC nacelle object as a VTK in legacy format.

    Inputs:
       nacelle        Data structure of MARC nacelle                [Unitless]
...
def write_nacelle_data(nac_pts,filename,origin_offset):
    """
    Writes data for a MARC nacelle object as a VTK in legacy format.
