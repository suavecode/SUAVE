...
from MARC.Methods.Aerodynamics.Common.Fidelity_Zero.Helper_Functions import windmilling_drag
from MARC.Methods.Aerodynamics.Common.Fidelity_Zero.Helper_Functions import estimate_2ndseg_lift_drag_ratio
from MARC.Methods.Aerodynamics.Common.Fidelity_Zero.Helper_Functions import asymmetry_drag
from MARC.Methods.Aerodynamics.Fidelity_Zero.Lift import compute_max_lift_coeff
...
def estimate_take_off_field_length(vehicle,analyses,airport,compute_2nd_seg_climb = 0):
    ...
    Inputs:
    analyses.base.atmosphere               [MARC data type]
    airport.
      altitude                             [m]
      delta_isa                            [K]
    vehicle.
    ...
    conditions.update( MARC.Analyses.Mission.Segments.Conditions.Aerodynamics() )
