...
def propeller_single_point(prop,
    ...
    """propeller_single_point(prop,
        ...
        Uses MARC's BEVW propeller model to evaluate propeller performance at a
        ...
        Inputs:
            ...
            prop                 MARC Propeller Data Structure
            ...
            analyses             MARC Analyses Structure
                .atmosphere      MARC Atmosphere Analysis Object
            plots                Flag for Plot Generation                      [Boolean]
            print_results        Flag for Terminal Output                      [Boolean]

        Outputs:

            results                             MARC Data Object
    ...
    conditions                                      = MARC.Analyses.Mission.Segments.Conditions.Conditions()
