...
def electric_payload_range(vehicle,
    ...
    """electric_payload_range(vehicle,
        ...
        Variable Cruise Distance - State of Charge MARC Mission and Vehicle.
        ...
        Inputs:
            ...
            vehicle                         MARC Vehicle Structure
                .mass_properties            MARC Mass Properties Structure
            ...
            mission                         MARC Mission Structure
