...
def wing(wing,
    ...
    """weight = MARC.Methods.Weights.Buildups.Common.wing(
            wing,
            config,
            maxThrust,
            numAnalysisPoints,
        ...
        Intended for use with the following MARC vehicle types, but may be used
        elsewhere:
        ...
        are made based on MARC's Solids Attributes library.
