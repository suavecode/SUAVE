...
from MARC.Methods.Weights.Correlations.Common import wing_main as wing_main
...
def empty(vehicle):
    ...
    vehicle.landing_gear.nose       = MARC.Components.Landing_Gear.Main_Landing_Gear()
    vehicle.landing_gear.nose.mass  = output.structures.nose_landing_gear
    vehicle.landing_gear.main       = MARC.Components.Landing_Gear.Nose_Landing_Gear()   
