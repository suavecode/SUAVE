...
from MARC.Methods.Weights.Correlations.FLOPS.prop_system import total_prop_flops
from MARC.Methods.Weights.Correlations.FLOPS.systems import systems_FLOPS
from MARC.Methods.Weights.Correlations.FLOPS.operating_items import operating_items_FLOPS
from MARC.Methods.Weights.Correlations.FLOPS.wing import wing_weight_FLOPS
from MARC.Methods.Weights.Correlations.FLOPS.tail import tail_horizontal_FLOPS
from MARC.Methods.Weights.Correlations.FLOPS.tail import tail_vertical_FLOPS
from MARC.Methods.Weights.Correlations.FLOPS.fuselage import fuselage_weight_FLOPS
from MARC.Methods.Weights.Correlations.FLOPS.landing_gear import landing_gear_FLOPS
from MARC.Methods.Weights.Correlations.FLOPS.payload import payload_FLOPS

from MARC.Methods.Weights.Correlations.Common.systems import systems
from MARC.Methods.Weights.Correlations.Transport.tail_horizontal import tail_horizontal
from MARC.Methods.Weights.Correlations.Transport.tail_vertical import tail_vertical
from MARC.Methods.Weights.Correlations.Transport.operating_items import operating_items
from MARC.Methods.Weights.Correlations.Transport.tube import tube
from MARC.Methods.Weights.Correlations.Common import wing_main
from MARC.Methods.Weights.Correlations.Common import landing_gear as landing_gear_weight
from MARC.Methods.Weights.Correlations.Common import payload as payload_weight

from MARC.Methods.Weights.Correlations.Raymer import wing_main_raymer
from MARC.Methods.Weights.Correlations.Raymer.tail import tail_horizontal_Raymer, tail_vertical_Raymer
from MARC.Methods.Weights.Correlations.Raymer import fuselage_weight_Raymer
from MARC.Methods.Weights.Correlations.Raymer import landing_gear_Raymer
from MARC.Methods.Weights.Correlations.Raymer import systems_Raymer
from MARC.Methods.Weights.Correlations.Raymer import total_prop_Raymer

from MARC.Attributes.Solids.Aluminum import Aluminum

def empty_weight(vehicle, settings=None, method_type='New MARC'):
    """ Main function that estimates the zero-fuel weight of a transport aircraft:
        ...
        Source:
            ...
            MARC method: http://aerodesign.stanford.edu/aircraftdesign/AircraftDesign.html
    ...
    Wings = MARC.Components.Wings
    Nets  = MARC.Components.Energy.Networks    
    ...
    vehicle.payload.passengers = MARC.Components.Physical_Component()
    vehicle.payload.baggage    = MARC.Components.Physical_Component()
    vehicle.payload.cargo      = MARC.Components.Physical_Component()
    ...
    output.structures.paint = 0  # TODO reconcile FLOPS paint calculations with Raymer and MARC baseline
    ...
    if not hasattr(vehicle.landing_gear, 'nose'):
        vehicle.landing_gear.nose       = MARC.Components.Landing_Gear.Nose_Landing_Gear()
    vehicle.landing_gear.nose.mass  = output.structures.nose_landing_gear
    if not hasattr(vehicle.landing_gear, 'main'):
        vehicle.landing_gear.main       = MARC.Components.Landing_Gear.Main_Landing_Gear()   
