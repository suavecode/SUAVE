...
from MARC.Methods.Propulsion.Rotor_Wake.Fidelity_Zero.compute_wake_contraction_matrix import compute_wake_contraction_matrix
...
def generate_fidelity_one_wake_shape(wake,rotor):
    ...
    Inputs:
       rotor  -  A MARC rotor component for which the wake is generated
