...
from MARC.Methods.Aerodynamics.Common.Fidelity_Zero.Lift.BET_calculations import compute_airfoil_aerodynamics,compute_inflow_and_tip_loss
import numpy as np
import scipy as sp
...
def fidelity_zero_wake_convergence(wake,rotor,wake_inputs):
    ...
    if ier!=1:
        print(rotor.tag + " BEVW did not converge to a solution (Stall)")
