...
from MARC.Methods.Noise.Common                         import convert_to_third_octave_band
...
def compute_harmonic_noise(harmonics,freestream,angle_of_attack,coordinates,
    ...
    #res.SPL_prop_harmonic_bpf_spectrum_dBA = A_weighting_metric(res.SPL_prop_harmonic_bpf_spectrum,res.f[:,:,:,0,:]) 
