...
from MARC.Methods.Noise.Common  import noise_tone_correction
from MARC.Methods.Noise.Common  import atmospheric_attenuation 
from MARC.Methods.Noise.Common  import SPL_arithmetic
from MARC.Methods.Noise.Metrics import PNL_noise_metric
from MARC.Methods.Noise.Metrics import EPNL_noise_metric
from MARC.Methods.Noise.Metrics import SENEL_noise_metric_single_point
from MARC.Methods.Noise.Metrics import A_weighting_metric 
from MARC.Methods.Noise.Output  import print_engine_output
...
def noise_SAE(turbofan,segment,analyses,config,settings,ioprint = 0, filename = 0):  
    ...
    Inputs:
        ...
        airport   - MARC type airport data, with followig fields:
            atmosphere                  - Airport atmosphere (MARC type)
    ...
    for id in range(0,nsteps):
        ...
        SPLt_dBA                = A_weighting_metric(SPL_total,frequency)
        SPLt_dBA_history[id][:] = A_weighting_metric(SPL_total,frequency)
    ...
    PNL_primary             =  PNL_noise_metric(SPL_primary_history)  
    PNL_secondary           =  PNL_noise_metric(SPL_secondary_history)  
    PNL_mixed               =  PNL_noise_metric(SPL_mixed_history)  
