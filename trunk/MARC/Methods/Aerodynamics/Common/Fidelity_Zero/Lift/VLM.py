...
from MARC.Methods.Aerodynamics.Common.Fidelity_Zero.Lift.compute_wing_induced_velocity      import compute_wing_induced_velocity
...
from MARC.Methods.Aerodynamics.Common.Fidelity_Zero.Lift.compute_RHS_matrix                 import compute_RHS_matrix 
...
def VLM(conditions,settings,geometry):
    ...
    The user has the option to use the boundary conditions and induced velocities from either MARC
    ...
    #MARC uses radians and its Units system. All algular variables will be in radians or var*Units.degrees
    ...
    # spanwise strip exposure flag, always 0 for MARC's infinitely thin airfoils. Needs to change if thick airfoils added
    RJTS = 0                         
