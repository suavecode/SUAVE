...
def translate_conditions_to_cases(avl ,conditions):
    """ Takes MARC Conditions() data structure and translates to a Container of
    avl Run_Case()s.
...
def translate_results_to_conditions(cases,results):
    ...
    # set up aerodynamic Conditions object
    res                             = MARC.Analyses.Mission.Segments.Conditions.Aerodynamics() 
    ...
    res.aerodynamics.drag_breakdown.induced                  = MARC.Analyses.Mission.Segments.Conditions.Conditions()
