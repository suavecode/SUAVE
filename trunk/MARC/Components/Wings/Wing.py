...
import MARC
from MARC.Core import Data, ContainerOrdered, Container
from MARC.Components import Lofted_Body, Mass_Properties, Physical_Component
from MARC.Components.Airfoils import Airfoil
...
class Wing(Lofted_Body):
    """This class defines the wing in MARC
    ...
    def __defaults__(self):
        """This sets the default values of a wing defined in MARC.
        ...
        self.control_surfaces                  = MARC.Core.Container()
        self.Fuel_Tanks                        = MARC.Core.Container()
