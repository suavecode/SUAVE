...
# ----------------------------------------------------------------------
import MARC
from MARC.Core import Data, ContainerOrdered
from MARC.Components import Component, Lofted_Body
import numpy as np
...
class Segment(Lofted_Body.Segment):
    def __defaults__(self):
        """This sets the default for wing segments in MARC.
        ...
        self.Airfoil               = MARC.Core.ContainerOrdered()
        self.generative_design_minimum           = 2
        self.generative_design_max_per_vehicle   = 10
        self.generative_design_special_parent    = MARC.Components.Wings.Main_Wing
