...
from MARC.Methods.Propulsion.rayleigh import rayleigh
from MARC.Methods.Propulsion.fm_solver import fm_solver
...
class Combustor(Energy_Component):
    ...
    def __defaults__(self):
        ...
        self.fuel_data                       = MARC.Attributes.Propellants.Jet_A()
        self.alphac                          = 0.0
