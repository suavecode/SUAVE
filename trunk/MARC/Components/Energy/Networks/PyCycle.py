...
from MARC.Components.Energy.Networks import Propulsor_Surrogate
...
class PyCycle(Propulsor_Surrogate):
    """ This is a way for you to run PyCycle, create a deck, and load the deck into a MARC surrogate
