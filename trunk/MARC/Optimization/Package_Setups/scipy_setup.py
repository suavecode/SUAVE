...
import numpy as np
import scipy as sp
from MARC.Optimization.Package_Setups.particle_swarm_optimization import particle_swarm_optimization 
...
def SciPy_Solve(problem,solver='SLSQP', sense_step = 1.4901161193847656e-08, iter =200, tolerance = 1e-6, pop_size =  10 , prob_seed = None ):  
    """ This converts your MARC Nexus problem into a SciPy optimization problem and solves it
...
def SciPy_Problem(problem,x):
    """ This wrapper runs the MARC problem and is called by the Scipy solver.
