...
def Pyoptsparse_Solve(problem,solver='SNOPT',FD='single', sense_step=1.0E-6,  nonderivative_line_search=False):
    """ This converts your MARC Nexus problem into a PyOptsparse optimization problem and solves it.
    ...
    opt_prob = pyOpt.Optimization('MARC',mywrap)
...
def PyOpt_Problem(problem,xdict):
    """ This wrapper runs the MARC problem and is called by the PyOpt solver.
