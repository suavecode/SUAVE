...
class Nexus(Data):
    ...
    def __defaults__(self):
        """This sets the default values.
            ...
            None
        """          
        self.vehicle_configurations = MARC.Components.Configs.Config.Container()
        self.analyses               = MARC.Analyses.Analysis.Container()
        self.missions               = None
    ...
    def evaluate(self,x = None):
        """This function runs the problem you setup in MARC.
