...
modules = [
    ...
    #'scripts/mission_range_and_weight_sizing/size_range_from_weights.py', 
    #'scripts/mission_range_and_weight_sizing/take_off_weight_from_tofl.py', 
    #'scripts/mission_range_and_weight_sizing/size_weight_from_range.py', 
    ...
    'scripts/segments/single_point_segment_test.py', 
