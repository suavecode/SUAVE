...
modules = [
    ...
    'scripts/noise_fidelity_zero_optimization/Noise_Test.py', 
    'scripts/noise_fidelity_zero/rotor_noise.py',
    'scripts/noise_fidelity_zero/aircraft_noise_certification_test.py',
    'scripts/noise_fidelity_zero/digital_elevation_aircraft_noise.py', 
