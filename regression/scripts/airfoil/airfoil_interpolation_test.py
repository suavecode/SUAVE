...
def main():
    ...
    airfoils_path = ospath.split('airfoil' + separator + 'airfoil_interpolation_test.py')[0] + 'Vehicles/Airfoils' + separator
    a_labels      = ["Clark_y", "E63"]
    nairfoils     = 4   # number of total airfoils
    
    a1            = airfoils_path + a_labels[0]+ ".txt"
    a2            = airfoils_path + a_labels[1]+ ".txt"
    new_files     = generate_interpolated_airfoils(a1, a2, nairfoils,npoints=100,save_filename="Transition",plot_airfoils=True)
