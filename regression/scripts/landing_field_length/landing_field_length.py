...
def main():
    ...
    landing_config.wings['main_wing'].control_surfaces.flap.deflection_angle = 30. * Units.deg
    landing_config.wings['main_wing'].control_surfaces.slat.deflection_angle = 25. * Units.deg
