...
def vehicle_setup(): 
    ...
    nacelle.length          = 0.95 
    nacelle.origin          = [[-0.2, 1.347, 0.0], [-0.2, 3.2969999999999997, 0.0],
    ...
    rot.origin                   = [[-0.2, 1.347, 0.0], [-0.2, 3.2969999999999997, 0.0],
                                    [-0.2, -1.347, 0.0], [-0.2, -3.2969999999999997, 0.0], 
                                    [4.938, 1.347, 1.54], [4.938, 3.2969999999999997, 1.54],
                                    [4.938, -1.347, 1.54], [4.938, -3.2969999999999997, 1.54]]
    ...
    motor_origins_front                                   = np.array( [[-0.2, 1.347, 0.0], [-0.2, 3.2969999999999997, 0.0],
                                                                       [-0.2, -1.347, 0.0], [-0.2, -3.2969999999999997, 0.0]]) 
    motor_origins_rear                                    = np.array([[4.938, 1.347, 1.54], [4.938, 3.2969999999999997, 1.54],
                                                                     [4.938, -1.347, 1.54], [4.938, -3.2969999999999997, 1.54]])
