...
""" setup file for the Concorde Inlet
"""
...
def vehicle_setup():
    ...
    inlet_nozzle.areas.inlet_capture   = 3*1.1/2.**2*np.pi* Units['meter**2']  # 3.772021238
    inlet_nozzle.areas.engine_face     = 3*1.1/2.**2*np.pi* Units['meter**2'] 
    inlet_nozzle.areas.ramp_area       = 1.5*1.2*1.1/2.**2*np.pi* Units['meter**2']
    inlet_nozzle.areas.drag_direct_projection = 1/16*0.5*4.7 * Units['meter**2'] 
    inlet_nozzle.angles.ramp_angle     = 6.0 * Units.deg
