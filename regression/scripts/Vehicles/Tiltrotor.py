...
def configs_setup(vehicle):
    ...
    config.networks.battery_rotor.rotors['propeller_1'].inputs.y_axis_rotation=  vector_angle
    config.networks.battery_rotor.rotors['propeller_2'].inputs.y_axis_rotation =  vector_angle 
