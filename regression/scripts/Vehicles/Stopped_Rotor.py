...
def vehicle_setup():
    ...
    propeller_motor.nominal_voltage      = bat.max_voltage *3/4 
    ...
    propeller_motor.gear_ratio           = 1. 
    propeller_motor.gearbox_efficiency   = 1. # Gear box efficiency    
    propeller_motor.no_load_current      = 2.0 
    propeller_motor                      = compute_optimal_motor_parameters(propeller_motor,propeller)
    ...
    rotor_motor.gear_ratio           = 1.0
    rotor_motor.gearbox_efficiency   = 1.0 
    rotor_motor.no_load_current      = 4.0     
    rotor_motor                      = compute_optimal_motor_parameters(rotor_motor,rotor)
