...
def mission_setup(analyses):
    ...
    segment.analyses.extend( analyses.full_engine )
    
    segment.altitude_start = 6.0 * Units.km
    ...
    segment.analyses.extend( analyses.simple_engine )
...
def check_results(new_results,old_results):
    ...
    check_list = [
        'segments.climb_4.conditions.aerodynamics.angle_of_attack',
        'segments.climb_4.conditions.aerodynamics.drag_coefficient',
        'segments.climb_4.conditions.aerodynamics.lift_coefficient',
        'segments.climb_4.conditions.propulsion.throttle',
        'segments.climb_4.conditions.weights.vehicle_mass_rate',
    ]
