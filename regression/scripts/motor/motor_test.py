...
def main():
    ...
    # Truth values
    omega_1_truth    = 197.3100865178771
    torque_1_truth   = 934.3967667083742
    current_2_truth  = 572.1810424084946
    torque_3_truth   = 803.1971917613615
    voltage_4_truth  = 417.0863609031858
    current_4_truth  = 665.3182086911492
