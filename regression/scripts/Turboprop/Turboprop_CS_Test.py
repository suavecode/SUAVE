...
def Turboprop_CS(vehicle):
    
    # Replace the C172 engine and propeller with a dummy turboprop with a constant speed propeller
    # Let's assume its an STC or 172RG 
    
    # build network
    net                                         = SUAVE.Components.Energy.Networks.Turboprop_Constant_Speed()
    net.tag                                     = 'turboprop'
