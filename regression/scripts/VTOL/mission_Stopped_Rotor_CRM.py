...
from Stopped_Rotor_CRM import sr_vehicle_setup 
...
def sr_full_setup():
    ...
    # vehicle analyses
    analyses = sr_base_analysis(vehicle)

    # mission analyses
    mission  = sr_mission_setup(analyses,vehicle)
...
#   Plot Results
# ----------------------------------------------------------------------
def sr_plot_mission(results,vec_configs): 
    line_color = 'bo-'
    axis_font = {'size':'14'} 
    fig = plt.figure( )
