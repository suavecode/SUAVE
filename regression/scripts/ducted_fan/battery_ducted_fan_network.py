...
def energy_network():
    ...
    battery_ducted_fan                      = MARC.Components.Energy.Networks.Battery_Ducted_Fan()
    ...
    esc.efficiency                  = 0.97 
    battery_ducted_fan.electronic_speed_controllers.append(esc)    
    ...
    conditions.propulsion.battery.energy               = bat.pack.max_energy * ones_1col
    ...
    conditions.propulsion.battery.energy               = bat.pack.max_energy*np.ones_like(ones_1col)
