# dual_battery_ducted_fan_network.py
# 
# Created:  May 2020, E. Botero
#        

""" create and evaluate a dual battery ducted fan network
"""
...
def energy_network():
    ...
    ducted_fan = SUAVE.Components.Energy.Networks.Dual_Battery_Ducted_Fan()
