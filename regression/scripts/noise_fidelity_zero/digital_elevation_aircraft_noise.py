...
from MARC.Methods.Noise.Metrics import * 
from MARC.Methods.Performance.estimate_stall_speed                          import estimate_stall_speed 
from MARC.Methods.Noise.Common.generate_microphone_points                   import generate_terrain_elevated_microphone_points
...
def main():   
    ...
    X57_SPL_true   = 67.17460966174006
...
def base_analysis(vehicle,microphone_terrain_data,airport_geospacial_data):
    ...
    noise.settings.aircraft_departure_coordinates   = airport_geospacial_data.departure_coordinates
    noise.settings.aircraft_destination_coordinates = airport_geospacial_data.destination_coordinates
...
def plot_results(results):   
    ...
    regression_plotting_flag = False # set to false for regression
