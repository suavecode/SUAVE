...
def main():
    ...
    vehicle.wings['main_wing'].control_surfaces.flap.configuration_type  = 'double_slotted'
    constraint_results = ca.create_constraint_diagram(vehicle)
    ...
    constraint_results = ca.create_constraint_diagram(vehicle)
    vehicle.wings['main_wing'].control_surfaces.flap.configuration_type  = 'single_slotted_Fowler'
    ...
    vehicle.wings['main_wing'].control_surfaces.flap.configuration_type  = 'double_slotted_Fowler'
    constraint_results = ca.create_constraint_diagram(vehicle)
