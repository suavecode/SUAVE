...
def main():
    ...
    actual.fuel            = 12743.06871035153  # includes cargo #22177.6377131 #without cargo
    actual.empty           = 38922.82313714847
    ...
    actual.vertical_tail   = 628.2844155798182
    actual.rudder          = 251.31376623192727
