...
def main():
    ...
    actual         = Data()
    actual.bag     = 0.
    actual.empty   = 1188.7588038905585
    actual.fuel    = 144.69596603

    actual.wing            = 164.68050134264192
    actual.fuselage        = 125.5242238367346
    actual.propulsion      = 658.7448842946857  
    actual.landing_gear    = 77.81189000964443
    actual.furnishing      = 49.713723752
    actual.electrical      = 41.28649399649684
    actual.control_systems = 20.5169772101498
    actual.fuel_systems    = 20.173688786768366
    actual.systems         = 134.88502014956853
