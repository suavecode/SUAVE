...
def main():
    ...
    wing.sweep.quarter_chord      = .4363323 * Units.rad       # sweep angle in degrees
    ...
    wing.sweep.quarter_chord      = 38.     * Units.deg       # Sweep of the horizontal tail
    ...
    wing.sweep.quarter_chord = 40.     * Units.deg       # Sweep of the vertical tail
