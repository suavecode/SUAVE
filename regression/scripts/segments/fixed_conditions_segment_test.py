...
def main():                
    ...
    RPM_cruise    = results.segments.cruise.conditions.propulsion.propeller_rpm[3][0]
    RPM_single_pt = results.segments.single_point.conditions.propulsion.propeller_rpm[3][0]
...
def mission_setup(analyses,vehicle): 
    ...
    #segment.state.numerics.number_control_points        = 1
    segment.tag = "cruise" 
    segment.analyses.extend(analyses.base) 
    ...
    segment.altitude    =  8012. * Units.feet
    segment.air_speed   =  140.91 * Units['mph']  
    segment.body_angle  =  0.07041734 # extracted from cruise result
    segment.throttle    =  0.51785208 # extracted from cruise result
    segment = vehicle.networks.battery_propeller.add_unknowns_and_residuals_to_segment(segment)  
