...
def main():
    ...
    lift_r =  np.array([-1.21717725,-0.48834678, -0.43513292, -0.34905432, -0.20408619,  
                        0.11639443, 0.35885614, 0.58519051, 0.87954539, 1.24175256,  
                        1.26009375,  ])[:,None]   
    print('lift = ', lift)
...
def reg_values():
    cd_c_r = np.array([[6.14520681e-06,2.39396708e-08, 1.51551199e-22, 2.54716401e-09, 
                        2.22707960e-04, 2.87294510e-05,1.22059940e-09, 2.10314398e-11, 
                        3.93646976e-05, 3.44901456e-03, 6.39106290e-14]]).T   

    cd_i_r = np.array([[0.03023895,0.01073633,0.00931997,0.00583096,0.00174568,   
                        0.00159063,0.00832076,0.01975201,0.03730735,0.06290215,   
                        0.08277828]]).T    
    ...
    cd_tot_r        = np.array([[ 0.04888647, 0.02923669, 0.03769832, 0.02377648, 0.02143556,
                                  0.01719576, 0.02709711, 0.04325638, 0.05649192, 0.08461324,
                                  0.10321906]]).T 
