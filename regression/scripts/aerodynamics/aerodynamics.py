...
def main():
    ...
    lift_r =  np.array( [-0.5314805 ,-0.46257758,-0.40914522,-0.32423973,-0.1833707 , 0.13346878,
                         0.3747775 , 0.59913231, 0.8890484 , 1.23507923, 1.2708168   ])[:,None]
...
def reg_values():
    cd_c_r = np.array([[8.70481049e-04,6.83251866e-08,3.76638258e-22,5.18285106e-09,
                        3.30952936e-04,2.12798634e-05,5.93359907e-10,7.52844556e-12,
                        1.09333545e-05,9.21862278e-04,1.75601762e-14 ]]).T   
    
    cd_i_r = np.array([[ 0.01145242,0.00879622,0.0074993 ,0.00430387,
                         0.00139279,0.00071404,0.00579094,0.01540122,
                         0.03252484,0.06188462,0.06668917 ]]).T 
    ...
    cd_tot_r        = np.array([[0.03065413,0.02725783,0.03584124,0.02221885,
                                 0.02119178,0.01629418,0.0245167 ,0.03881858,
                                 0.05158456,0.0809736 ,0.08680817]]).T
