...
def main():
    ...
    lift_r =  np.array( [-0.75426388,-0.46186849,-0.40913328,-0.32436176,-0.18443341, 0.13313522,
                         0.37477943, 0.59912482, 0.88782408, 1.2415595 , 1.27083107])[:,None]
...
def reg_values():
    cd_c_r = np.array([[2.46836322e-05,1.63881448e-08,1.11699131e-22,2.06671837e-09,
                        2.04716020e-04,3.69159061e-05,1.87158804e-09,3.47615103e-11,
                        6.18295379e-05,3.99529735e-03,7.39462478e-14]]).T    
    
    cd_i_r = np.array([[ 0.02306583,0.00876928,0.00749886,0.00430711,
                         0.00140898,0.00071047,0.005791  ,0.01540084,
                         0.03243532,0.06253572,0.06669067]]).T  
    ...
    cd_tot_r        = np.array([[0.04158805,0.02723029,0.03584079,0.02222215,
                                 0.02107094,0.01630625,0.02451676,0.03881818,
                                 0.05154588,0.0848626 ,0.0868097 ]]).T 
