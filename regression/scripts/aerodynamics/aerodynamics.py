...
def main():
    ...
    lift_r =  np.array([-1.09674658, -0.47114311, -0.43521261, -0.33701616, -0.12474031,
...
def reg_values():
    cd_c_r = np.array([[1.59207348e-05, 2.75529031e-08, 1.55309728e-22, 2.79898580e-09,
                        3.64175852e-04, 3.57418878e-05, 1.28566578e-09, 2.16312074e-11,
                        4.22229353e-05, 3.62459052e-03, 6.30820499e-14]]).T   

    cd_i_r = np.array([[0.03585184, 0.0135707 , 0.01243003, 0.00774839, 0.00251712,
    ...
    cd_tot_r        = np.array([[0.05341749, 0.03150408, 0.03993323, 0.0251143 , 0.0216638 ,
