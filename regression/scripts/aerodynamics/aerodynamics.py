...
def reg_values():
    cd_c_r = np.array([[2.77841166e-09,9.54913908e-10,3.09611169e-23,1.00920702e-09,9.88085452e-05,\
                        1.98202770e-05,9.14384129e-10,1.80326366e-11,4.49667249e-05,4.00421207e-03,\
                        6.67689658e-14 ]]).T
           
    cd_i_r = np.array([[2.27876780e-01,3.54372959e-02,1.61976525e-02,7.13501360e-03,3.48579702e-03,\
                        1.59548021e-04,3.18067087e-03,1.04211983e-02,2.91358885e-02,7.24760147e-02,\
                        5.36840226e-02   ]]).T

          
    cd_m_r = np.array([[0.00117354,0.00117354,0.00117354,0.00117354,0.00117354,
                        0.00117354,0.00117354,0.00117354,0.00117354,0.00117354,
                        0.00117354 ]]).T
    ...
    cd_tot_r        = np.array([[ 0.25047299,0.05431246,0.04451354,0.02499122,0.02297848,\
                                  0.01562915,0.02173288,0.03358149,0.04804212,0.09480361,\
                                  0.07342044 ]]).T
