...
def main():
    ...
    lift_r =  np.array([-0.78654498,-0.48562864,-0.4312893 ,-0.3442654 ,-0.19773265, 0.12732151,
                        0.37221063, 0.60102923, 0.90031948,1.26978863 , 1.2846731 ] )[:,None] 
...
def reg_values():
    cd_c_r = np.array([[2.11913428e-05,1.46705624e-08,1.00786717e-22,1.89664057e-09,
                        1.97066436e-04,3.69256330e-05,1.88894447e-09,3.54759275e-11,
                        6.37419857e-05,3.95877837e-03,7.35755549e-14]]).T   
    
    cd_i_r = np.array([[ 0.02508243,0.00969473,0.00833303,0.00485191,
                         0.00161951,0.00064978,0.00571189,0.0154989 ,
                         0.03335475,0.06541178,0.06815139]]).T   
    ...
    cd_tot_r        = np.array([[0.04364106,0.02817425,0.03669165,0.02277785,
                                 0.02127734,0.0162443 ,0.02443606,0.03891821,
                                 0.05248558,0.08775736,0.08829963]]).T 
