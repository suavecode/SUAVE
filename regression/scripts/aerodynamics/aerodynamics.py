...
def main():
    ...
    lift_r = np.array([-0.80758369,-0.53793625,-0.49402474,-0.4002442 ,-0.25041288, 0.06952791,
                       0.30958113, 0.53876934, 0.83313196, 1.21019757, 1.22349627 ])[:,None]  
...
def reg_values(): 
    cd_c_r = np.array([[8.30550674e-04,5.56354044e-08,2.99264287e-22,4.21475036e-09,2.75091169e-04,
                        1.78847844e-05,4.99511835e-10,6.43540826e-12,9.50369943e-06,8.55314475e-04,1.56965045e-14]]).T     
          
    cd_i_r = np.array([[0.0264539 ,0.01190049,0.01093989,0.00656064,0.00259863,
                        0.00019384,0.003953  ,0.01246028,0.02857405,0.05944007,0.06184012]]).T
    ...
    cd_tot_r        = np.array([[0.05083286,0.03047097,0.03942149,0.02456547,0.02355807,
                                 0.01583764,0.02268838,0.03587671,0.04760541,0.07869042,0.08190856]]).T
