...
def reg_values():
    ...
    cd_i_r = np.array([[0.20534655, 0.02643875, 0.00829106, 0.00119785, 0.00167785, 
                        0.01050974,0.02008818 ,0.03957499, 0.0882211, 0.19242021,
                        0.13041833]]).T
    ...
    cd_tot_r        = np.array([[ 0.22606894 , 0.0446343 , 0.03557503, 0.01844746 , 0.021461 , 
                                  0.0258904 , 0.03846136 , 0.06263895 , 0.10784831 , 0.2137311, 
                                  0.15116345]]).T
