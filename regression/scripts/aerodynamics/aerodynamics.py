...
def main():
    ...
    lift_r =  np.array([-1.16963662, -0.46357431, -0.41127969, -0.32637248, -0.18580847,
                        0.1320477 ,  0.37474492,  0.597934  ,  0.88040067,  1.21981811,
                        1.24646245])[:,None]   
...
def reg_values():
    cd_c_r = np.array([[8.63780385e-06, 2.76673493e-08, 1.73697452e-22, 2.88441473e-09,
                        2.43303795e-04, 3.03044478e-05, 1.27366347e-09, 2.14506225e-11,
                        3.84322996e-05, 3.29661478e-03, 6.21673184e-14]]).T   

    cd_i_r = np.array([[0.04226828, 0.01639316, 0.01500882, 0.0097069 , 0.00298783,
                        0.00100309, 0.00461781, 0.01443484, 0.03527979, 0.07003385,
                        0.07864703]]).T     
    ...
    cd_tot_r        = np.array([[0.05997176, 0.03438299, 0.04256359, 0.02711198, 0.02203976,
                                 0.01607665, 0.02267253, 0.03704668, 0.05380864, 0.09137461,
                                 0.0983451 ]]).T  
