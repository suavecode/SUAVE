...
def main():
    ...
    lift_r =  np.array([-0.80922985, -0.50129023, -0.44612508, -0.35903659, -0.21385219,
...
def reg_values():
    cd_c_r = np.array([[5.57674299e-05, 2.38229722e-08, 1.50849804e-22, 2.53784409e-09,
                        2.22291216e-04, 2.87116769e-05, 1.22123744e-09, 2.10647403e-11,
                        3.94589910e-05, 3.45561201e-03, 6.40938862e-14]]).T   

    cd_i_r = np.array([[0.01899817, 0.01176556, 0.01018932, 0.00649772, 0.00213861,
    ...
    cd_tot_r        = np.array([[0.03631529, 0.02966284, 0.0376477 , 0.02383861, 0.0211414 ,
