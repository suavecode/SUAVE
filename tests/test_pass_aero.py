...
def test():
    ...
    wing_aero2 = SUAVE.Attributes.Aerodynamics.PASS_Aero()
    wing_aero2.initialize(aircraft)
    aircraft.Aerodynamics = wing_aero2    
  

    [Cd2,Cl2]=aircraft.Aerodynamics(0,Seg)
  
  
    print 'Aerodynamics module test script'
    print 'aircraft Cl' , Cl2
    print 'aircraft Cd' , Cd2   
