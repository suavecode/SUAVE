...
def vehicle_setup():
    ...
    # mass properties
    vehicle.mass_properties.max_takeoff     = 185000. *0.4 * Units.kilogram   
    vehicle.mass_properties.operating_empty = 78700.*0.4 * Units.kilogram   
    vehicle.mass_properties.takeoff         = 185000.*0.4 * Units.kilogram   
    vehicle.mass_properties.cargo           = 1000.*0.0   * Units.kilogram   
    ...
    ramjet.areas             = Data()
    ramjet.areas.wetted      = 12.5*4.7*2. * Units['meter**2']  # 4.7 is outer perimeter on one side
    ramjet.origin            = [[37.,6.,-1.3],[37.,5.3,-1.3],[37.,-5.3,-1.3],[37.,-6.,-1.3]] # meters
    ...
    # setup
    nozzle.polytropic_efficiency = 1.
...
def mission_setup(analyses):
    ...
    segment.mach       = 2.02
    segment.altitude   = 12.0 * Units.km
